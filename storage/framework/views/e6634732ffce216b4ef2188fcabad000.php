...
<div class="max-w-6xl mx-auto px-6 py-8">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="<?php echo e(route('admin.users.index')); ?>" class="bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition">
            Kembali
        </a>
    </div>
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-4 border-b font-medium"><?php echo e($user->name); ?></td>
                        <td class="px-6 py-4 border-b"><?php echo e($user->email); ?></td>
                        ...
                        <td class="px-6 py-4 border-b text-center space-x-2">
                            ...
                            <form action="<?php echo e(route('admin.users.restore', $user->id)); ?>" method="POST" class="inline-block">
                                <?php echo csrf_field(); ?>
                            ...
                            <form action="<?php echo e(route('admin.users.delete_permanent', $user->id)); ?>" method="POST" class="inline-block">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('template.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\hotel-project\resources\views/admin/user/trash.blade.php ENDPATH**/ ?>