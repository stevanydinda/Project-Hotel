...
<head>
    ...
    <title>@yield('title', 'Hotel Aston')</title>
...
<body class="bg-gray-50 scroll-smooth">
    ...
    <nav class="flex justify-between items-center px-8 py-4 bg-white shadow-sm fixed w-full top-0 left-0 z-50">
        ...
        <div class="space-x-4">
            @auth
                @if (Auth::user()->role !== 'admin')
                    <a href="{{ route('user.jenis_kamar') }}"
                        class="hover:text-yellow-600 {{ Route::is('user.jenis_kamar') ? 'text-yellow-700 font-semibold' : '' }}">
                        Jenis Kamar
                    </a>
                    <a href="{{ route('user.my.bookings') }}"
                        class="hover:text-yellow-600 {{ Route::is('user.my.bookings') ? 'text-yellow-700 font-semibold' : '' }}">
                        Riwayat Booking
                    </a>
                @endif
                <span class="text-green-700 font-semibold">Halo, {{ Auth::user()->name }}</span>
            ...
            @else
                ...
                <a href="{{ route('signup') }}" class="hover:text-yellow-600">SignUp</a>
                <a href="{{ route('login') }}" class="hover:text-yellow-600">Login</a>
            @endauth
        </div>
    </nav>
    ...
    <main class="pt-24">
        ...
        @guest
            <section id="lokasi" class="py-16 bg-white flex flex-col items-center text-center">
                ...
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.6842170308515!2d106.83309747574223!3d-6.930083967806862!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69c5ee5f871091%3A0xc58549234bdf7d7c!2sAston%20Bogor%20Hotel%20%26%20Resort!5e0!3m2!1sid!2sid!4v1700000000000!5m2!1sid!2sid"
            ...
            <section id="eksplor" class="py-16 bg-gray-50 text-center">
                ...
                <div class="flex justify-center flex-wrap gap-6">
                    <div class="bg-white p-4 rounded-2xl shadow-md w-64">
                        <img src="{{ asset('images/pool.jpeg') }}" alt="Kolam Renang" class="rounded-xl mb-3">
                    ...
                    <div class="bg-white p-4 rounded-2xl shadow-md w-64">
                        <img src="{{ asset('images/spa.jpeg') }}" alt="Spa & Wellness" class="rounded-xl mb-3">
                    ...
                    <div class="bg-white p-4 rounded-2xl shadow-md w-64">
                        <img src="{{ asset('images/restaurant.jpeg') }}" alt="Restoran" class="rounded-xl mb-3">
    ...
    <script src="https://cdn.datatables.net/2.3.5/css/dataTables.tailwindcss.css"></script>

    {{-- Chart.js --}}
    <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>

    {{-- Tempat script dinamis --}}
    @stack('script')
