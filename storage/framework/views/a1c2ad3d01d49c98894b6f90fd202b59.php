<?php $__env->startSection('content'); ?>
    <div class="container mx-auto px-4 py-6 max-w-2xl">
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
            ...
            <div class="p-6">
               <form action="<?php echo e(route('user.kamar.booking.store', $room)); ?>" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" name="tgl_checkout" id="checkout"
                            min="<?php echo e(date('Y-m-d', strtotime('+1 day'))); ?>" class="w-full px-3 py-2 border rounded-lg"
                            required>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex items-center space-x-2">
                            ...
                            <input type="number" name="jnu_kamar_dipesan" id="jumlahKamar" min="1"
                                max="<?php echo e($room->stok); ?>" class="w-full px-3 py-2 border rounded-lg text-center"
                                value="1" required>
                        ...
                        <p class="text-sm text-gray-500 mt-1">Stok tersedia: <span
                                id="stockAvailable"><?php echo e($room->stok); ?></span> kamar</p>
                    </div>
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg mb-6">
                        ...
                        <div class="flex justify-between mb-1">
                            ...
                            <span class="font-semibold" id="pricePerNight">Rp
                                <?php echo e(number_format($room->harga, 0, ',', '.')); ?></span>
                        </div>
                        <div class="flex justify-between mb-1">
