...
<body class="bg-gray-50 scroll-smooth">
        ...
        <div class="space-x-4">
            @auth
                @if (Auth::user()->role !== 'admin')
                    @unless (Route::is('user.jenis_kamar'))
                    ...
                    <a href="{{ route('user.jenis_kamar') }}"
                        class="hover:text-yellow-600 {{ Route::is('user.jenis_kamar') ? 'text-yellow-700 font-semibold' : '' }}">Jenis
                        Kamar</a>
                @endif
    ...
    <main class="pt-24">
        ...
        {{--  bagian Lokasi & Eksplor hanya tampil kalau bukan di halaman jenis kamar --}}
        @auth
            @if (Auth::user()->role !== 'admin' && !Route::is('user.jenis_kamar'))
                {{-- Section Lokasi --}}
