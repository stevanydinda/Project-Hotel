            ...
            <?php if(auth()->guard()->check()): ?>
                <?php if(Auth::user()->role !== 'admin'): ?>
                    <a href="<?php echo e(route('user.jenis_kamar')); ?>"
                        class="hover:text-yellow-600 <?php echo e(Route::is('user.jenis_kamar') ? 'text-yellow-700 font-semibold' : ''); ?>">
                        Jenis Kamar
                    </a>
                    <a href="<?php echo e(route('user.my.bookings')); ?>"
                        class="hover:text-yellow-600 <?php echo e(Route::is('user.my.bookings') ? 'text-yellow-700 font-semibold' : ''); ?>">
                        Riwayat Booking
                    </a>
                <?php endif; ?>
...
<?php /**PATH C:\laragon\www\hotel-project\resources\views/template/app.blade.php ENDPATH**/ ?>