        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            ...
            <form method="POST" action="<?php echo e(route('admin.rooms.update', $room->id)); ?>" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="name" name="name" value="<?php echo e(old('name', $room->name)); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="tipe_kamar" name="tipe_kamar"
                        value="<?php echo e(old('tipe_kamar', $room->tipe_kamar)); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" id="jumlah_kamar" name="jumlah_kamar"
                        value="<?php echo e(old('jumlah_kamar', $room->jumlah_kamar)); ?>"
                        class="w-full px-4 py-2 border border-gray-300 rounded-md">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    ...
                    <textarea id="deskripsi" name="deskripsi" rows="4" class="w-full px-4 py-2 border border-gray-300 rounded-md"><?php echo e(old('deskripsi', $room->deskripsi)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" id="harga" name="harga" value="<?php echo e(old('harga', $room->harga)); ?>"
                ...
                <div class="mb-4">
                    ...
                    <input type="number" id="kapasitas" name="kapasitas" value="<?php echo e(old('kapasitas', $room->kapasitas)); ?>"
                        class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-yellow-500">
                </div>
