        ...
        <div class="space-x-4">
            <?php if(auth()->guard()->check()): ?>
                ...
                <?php if(Auth::user()->role !== 'admin'): ?>
                    ...
                    <a href="<?php echo e(route('user.jenis_kamar')); ?>" class="hover:text-yellow-600 <?php echo e(Route::is('user.jenis_kamar') ? 'text-yellow-700 font-semibold' : ''); ?>">Jenis Kamar</a>
                <?php endif; ?>
            ...
            <?php if(Auth::user()->role !== 'admin' && !Route::is('user.jenis_kamar')): ?>
                ...
                <section id="lokasi" class="py-16 bg-white flex flex-col items-center text-center">
                    ...
                    <iframe
                        ...
                        class="rounded-xl shadow-lg w-full max-w-3xl h-80"
                        style="border:0;"
                        allowfullscreen=""
                        loading="lazy"
