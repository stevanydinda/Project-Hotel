...
<div class="max-w-7xl mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <!-- Room Details -->
            <div class="p-6">
                <h3 class="text-xl font-bold mb-2"><?php echo e($room->name); ?></h3>
                ...
                <div class="mb-4">
                    <p class="text-2xl font-bold text-blue-700">
                        Rp <?php echo e(number_format($room->price ?? $room->harga ?? 0, 0, ',', '.')); ?>
...
<?php echo $__env->make('template.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\hotel-project\resources\views\user\room\index.blade.php ENDPATH**/ ?>